...
namespace Test_1 {
    ...
    public partial class csharpDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_usersDataTable : global::System.Data.TypedTableBase<tbl_usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public tbl_usersRow Addtbl_usersRow(string nickname, string username, string gender, string phone, string email, string password, bool disable, byte[] picture) {
        ...
        public partial class tbl_usersRow : global::System.Data.DataRow {
            ...
            public bool disable {
                get {
                    try {
                        return ((bool)(this[this.tabletbl_users.disableColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'disable\' in table \'tbl_users\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_users.disableColumn] = value;
                }
            }
            ...
            public bool IsdisableNull() {
                return this.IsNull(this.tabletbl_users.disableColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public void SetdisableNull() {
                this[this.tabletbl_users.disableColumn] = global::System.Convert.DBNull;
            }
...
namespace Test_1.csharpDataSetTableAdapters {
    ...
    public partial class tbl_usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_users] ([nickname], [username], [gender], [phone], [email], [password], [disable], [picture]) VALUES (@nickname, @username, @gender, @phone, @email, @password, @disable, @picture);
SELECT id, nickname, username, gender, phone, email, password, disable, picture FROM tbl_users WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_users] SET [nickname] = @nickname, [username] = @username, [gender] = @gender, [phone] = @phone, [email] = @email, [password] = @password, [disable] = @disable, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_nickname = 1 AND [nickname] IS NULL) OR ([nickname] = @Original_nickname)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_disable = 1 AND [disable] IS NULL) OR ([disable] = @Original_disable)));
SELECT id, nickname, username, gender, phone, email, password, disable, picture FROM tbl_users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Test_1.Properties.Settings.Default.csharpConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nickname, username, gender, phone, email, password, disable, picture F" +
                "ROM dbo.tbl_users";
        ...
        public virtual int Fill(csharpDataSet.tbl_usersDataTable dataTable) {
        ...
        public virtual csharpDataSet.tbl_usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            csharpDataSet.tbl_usersDataTable dataTable = new csharpDataSet.tbl_usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(csharpDataSet.tbl_usersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nickname, string Original_username, string Original_gender, string Original_phone, string Original_email, string Original_password, global::System.Nullable<bool> Original_disable) {
            ...
            if ((Original_disable.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((bool)(Original_disable.Value));
            }
            else {
        ...
        public virtual int Insert(string nickname, string username, string gender, string phone, string email, string password, global::System.Nullable<bool> disable, byte[] picture) {
            if ((nickname == null)) {
            ...
            if ((disable.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((bool)(disable.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((disable.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((bool)(disable.Value));
            }
            else {
            ...
            if ((Original_disable.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((bool)(Original_disable.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_password, 
                    global::System.Nullable<bool> Original_disable) {
            return this.Update(nickname, username, gender, phone, email, password, disable, picture, Original_id, Original_nickname, Original_username, Original_gender, Original_phone, Original_email, Original_password, Original_disable, Original_id);
        }
    }
